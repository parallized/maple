  ...
  return (
    <section className="h-full flex flex-col p-2">
      ...
      <div className="flex-1 min-h-0 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 auto-rows-fr">
        <article className="rounded-2xl bg-(--color-base-100) border border-[color-mix(in_srgb,var(--color-base-300)_40%,transparent)] p-6 flex flex-col gap-4">
        ...
        <article className="rounded-2xl bg-(--color-base-100) border border-[color-mix(in_srgb,var(--color-base-300)_40%,transparent)] p-6 flex flex-col gap-3">
          <div className="text-muted text-sm font-medium flex items-center gap-2">
        ...
        <article className="rounded-2xl bg-(--color-base-100) border border-[color-mix(in_srgb,var(--color-base-300)_40%,transparent)] p-6 flex flex-col gap-3 md:col-span-2 lg:col-span-2">
