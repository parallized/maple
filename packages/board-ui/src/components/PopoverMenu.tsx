      ...
      {items.map((item, index) => {
        ...
        return (
          <button
            ...
            type="button"
            role="menuitem"
            className="popover-item ui-btn ui-btn--sm ui-btn--ghost justify-start gap-2.5 w-full border border-transparent rounded-[8px] font-medium text-[14px] px-3 transition-colors"
