...
function OptionItem({
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <pre className="m-0 text-[12px] leading-[1.5] font-mono text-(--color-base-content) bg-[color-mix(in_srgb,var(--color-base-200)_65%,transparent)] border border-[color-mix(in_srgb,var(--color-base-300)_45%,transparent)] rounded-[8px] px-2.5 py-1.5 whitespace-pre-wrap break-words select-all">
        {option.command}
      </pre>
      {note ? (
      ...
      <div className="flex flex-col gap-3">
        ...
        {nativeOptions.length > 0 && (
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center gap-1.5 text-[12px] font-sans font-medium text-muted">
              <Icon icon="mingcute:computer-line" className="text-[14px] opacity-60" />
        ...
        {wslOptions.length > 0 && (
          <div className="flex flex-col gap-1.5">
            <div className="flex items-center gap-1.5 text-[12px] font-sans font-medium text-muted">
              <Icon icon="mingcute:terminal-box-line" className="text-[14px] opacity-60" />
