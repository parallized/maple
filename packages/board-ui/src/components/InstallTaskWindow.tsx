      ...
      <div className="ui-modal-panel ui-modal-panel--console">
        <div className="worker-console-header">
          ...
          <div className="worker-console-actions flex items-center gap-2">
            <span className="text-[12px] text-muted font-sans opacity-80">
              {t(
        ...
        <div className="ui-modal-body worker-console-body">
          <div className="worker-console-pool">
            ...
            <div className="mt-3 flex items-center justify-between gap-2">
              ...
              {error ? (
                <span className="text-[12px] font-mono" style={{ color: "var(--color-error)" }}>
                  {error}
                </span>
              ) : null}
            </div>
          ...
          <div className="flex-1 min-h-0 flex flex-col">
            <div className="flex items-center justify-between gap-2 mb-2">
              ...
              {installing ? (
                <span className="text-[12px] text-muted font-sans opacity-70">{t("正在运行…", "Running…")}</span>
              ) : null}
            </div>
            ...
            >
              <pre className="m-0 text-[12px] leading-[1.55] font-mono text-(--color-base-content) whitespace-pre-wrap break-words">
